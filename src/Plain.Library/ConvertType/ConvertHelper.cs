...
namespace Plain.Library.ConvertType
{
    public class ConvertHelper
    {
        ...
        public static List<KeyValuePair<long, string>> GetEnumValues(Type enumType)
        {
            var result = new List<KeyValuePair<long, string>>();
            foreach (int i in Enum.GetValues(enumType))
                result.Add(new KeyValuePair<long, string>((long)i, Enum.GetName(enumType, i)));
            return result;
        }
    }
}
