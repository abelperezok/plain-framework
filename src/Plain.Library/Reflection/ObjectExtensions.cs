...
namespace Plain.Library.Reflection
{
    ...
    public static class ObjectExtensions
    {
        ...
        public static T GetPrivatePropertyValue<T>(this object obj, string propertyName)
        {
            ...
            if (pi == null) throw new ArgumentOutOfRangeException("propertyName", string.Format("ObjectPropertyNotFound", propertyName, obj.GetType().FullName));
        ...
        public static T GetPrivateFieldValue<T>(this object obj, string fieldName)
        {
            ...
            if (fi == null) throw new ArgumentOutOfRangeException("fieldName", string.Format("ObjectFieldNotFound", fieldName, obj.GetType().FullName));
